...
import Forum.PersistentLayer.Data.*;
...
private Date _writeDate;
 ...
 public Message(String nickname , String subject,String body,Date writeDate,Date modifedDate)
 {
 ...
 // new constractor
  public Message(String nickname , String subject,String body,Date writeDate,Date modifedDate, int indexId)
 {
     this._nickname=nickname;
     this._subject=subject;
     this._body=body;
